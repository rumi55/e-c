...
class Login 
{
	...
	public static $_login_page_admin ='index.php';
	public static $_dashboard='?page=products';
	public static $_login_admin ='aminId';

	public static $_valid_login = 'valid';
	public static $_referrer = 'refer';

	public static $_random = 's!D83Qv#$09P5@';
	...
	public static function stringhash($string=null)
	{
		if(!empty($string))
		{
			$saltedhash= self::$_random.$string;
			
			return hash('sha512', $saltedhash);
		}
	}
	...
	public static function loginAdmin($id =null, $url=null)
	{
		if(!empty($id))
		{
			$url=!empty($url) ? $url : self::$_dashboard;
