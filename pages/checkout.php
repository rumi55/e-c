...
if (!empty($user)) {
	...
	if ($objForm->isPost('first_name')) {
		...
		if($objValid->isValid())
		{
			...
			if ($objUser->updateUser($objValid->_post, $user['id'])) {
				...
				$mess = "<p class=\"red\">There was a problem updating your details.</p>";
				$mess .="<p>Please contact administrator.</p>";
			}
		} 
	}
	...
	<form action="" method="post" >
		<table cellpadding="0" cellpadding="0" border="0" class="tbl_insert">
			<tr>
				<th><label for="first_name">First Name:* </label></th>
				<td>
					<?php echo $objValid->validate('first_name'); ?>
					<input type="text" name="first_name" id="first_name" class="fld" 
					value="<?php echo $objForm->formText('first_name', $user['first_name']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('last_name'); ?>
					<input type="text" name="last_name" id="last_name" class="fld"
					 value="<?php echo $objForm->formText('last_name', $user['last_name']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('address_1'); ?>
					...
					value="<?php echo $objForm->formText('address_1', $user['address_1']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('address_2'); ?>
					...
					value="<?php echo $objForm->formText('address_2', $user['address_2']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('town'); ?>
					...
					value="<?php echo $objForm->formText('town', $user['town']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('county'); ?>
					...
					value="<?php echo $objForm->formText('county', $user['county']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<?php echo $objValid->validate('post_code'); ?>
					...
					value="<?php echo $objForm->formText('post_code', $user['post_code']); ?>" />	
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<?php echo $objForm->selectCountry($user['country']); ?>
				</td>
			</tr>		
			...
			<tr>
				...
				<?php echo $objValid->validate('email'); ?>
					...
					value="<?php echo $objForm->formText('email', $user['email']); ?>" />	
				</td>
			</tr>
